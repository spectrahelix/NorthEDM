...
const html = `<!doctype html><html><head><meta charset="utf-8"><style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .brand .tl{font-size:10.5px;letter-spacing:5px;color:rgba(57,255,20,.6);margin-top:2px}
  ...
  .foryou{font-size:13px;line-height:1.35;color:#cfd2da;max-width:670px;margin:5px auto 0}
  .foryou b{color:#fff}

  .st{font-size:12px;letter-spacing:5px;color:#9aa;text-align:center;margin:9px 0 6px}
  .st span{color:#39FF14}

  .big3{display:grid;grid-template-columns:1fr 1fr 1fr;gap:11px}
  .card{border:1px solid rgba(255,255,255,.10);border-radius:14px;padding:12px;background:rgba(255,255,255,.03)}
  ...
  .tile{border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:10px 12px;background:rgba(255,255,255,.02);display:flex;gap:9px;align-items:flex-start}
  .tile .ic{font-size:18px}
  .tile h4{font-size:14px}
  .tile p{font-size:11.5px;line-height:1.32;color:#b9bdc6;margin-top:2px}

  .fd{margin:8px 40px 0;border:1px solid rgba(251,146,60,.28);border-radius:16px;padding:10px 14px;
  ...
  .fd .body{font-size:12px;line-height:1.35;color:#cfd2da;margin-top:6px}
  .fd .body b{color:#fff}
  ...
  .fd .vis .orders img{width:120px;display:block;border-radius:9px;border:1px solid rgba(255,255,255,.08)}

  .found{margin:6px 40px 0;text-align:center;font-size:12px;line-height:1.34;color:#ffe;
    border:1px dashed rgba(57,255,20,.35);border-radius:11px;padding:6px 14px;background:rgba(57,255,20,.04)}
  .found b{color:#39FF14}

  .foot{margin-top:auto;padding:7px 40px 10px;border-top:1px solid rgba(255,255,255,.10);
